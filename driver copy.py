    ...
    try:
        while True:
            ...
            for job in done_jobs:
                ...
                if EXPERIMENT_MODE == 'ntm':
                    if neural_turing_machine.cur_episode < info['episode_number']:
                        neural_turing_machine.update_memory(deepcopy(current_memory_))
                        neural_turing_machine.cur_episode = info['episode_number']
